...
void main() {
  ...
  group('People', () {
    ...
    group('MovieCredits', () {
      test('with parameters', () async {
        final result = await tmdb.v3.people.getMovieCredits(103, language: 'en-IN');
    ...
    group('Tv credits', () {
      test('with parameters', () async {
        final result = await tmdb.v3.people.getTvCredits(103, language: 'en-IN');
    ...
    group('Combined Credits', () {
      test('with parameters', () async {
        final result = await tmdb.v3.people.getCombinedCredits(103, language: 'en-IN');
    ...
    group('External Id', () {
      test('with parameters', () async {
        final result = await tmdb.v3.people.getExternalIds(103, language: 'en-IN');
    ...
    group('Tagged images', () {
      test('with parameters', () async {
        final result = await tmdb.v3.people.getTaggedImages(103, language: 'en-IN');
    ...
    group('Translations', () {
      test('with parameters', () async {
        final result = await tmdb.v3.people.getTranslations(103, language: 'en-IN');
