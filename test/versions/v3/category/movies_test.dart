...
void main() {
  ...
  group('Movie', () {
    ...
    group('Now Playing', () {
      test('with parameters', () async {
        final result = await tmdb.v3.movies.getNowPlaying(language: 'en-IN', page: 3, region: 'IN');
    ...
    group('Popular', () {
      test('with parameters', () async {
        final result = await tmdb.v3.movies.getPopular(language: 'en-IN', page: 3, region: 'IN');
    ...
    group('Top rated', () {
      test('with parameters', () async {
        final result = await tmdb.v3.movies.getTopRated(language: 'en-IN', page: 3, region: 'IN');
    ...
    group('Upcoming', () {
      test('with parameters', () async {
        final result = await tmdb.v3.movies.getUpcoming(language: 'en-IN', page: 3, region: 'IN');
