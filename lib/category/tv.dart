...
class Tv {
  ...
  Tv(this._tmdb) : assert(_tmdb != null);
  ...
  Future<Map> getAlternativeTitle(int tvId, {Parameters parameters}) {
    assert(tvId != null);
    return _tmdb._query('$_endPoint/$tvId/alternative_titles',
        method: HttpMethod.GET, parameters: parameters);
  }
  ...
  Future<Map> getCredits(int tvId) {
    assert(tvId != null);
    return _tmdb._query('$_endPoint/$tvId/credits', method: HttpMethod.GET);
  }

  ///Get the list of content ratings (certifications) that have been added to a TV show.
  Future<Map> getContentRating(int tvId) {
    assert(tvId != null);
    return _tmdb._query('$_endPoint/$tvId/content_ratings');
  }

  /// Get all of the episode groups that have been created for a TV show
  Future<Map> getEpisodeGroups(int tvId, {Parameters parameters}) {
    assert(tvId != null);
    return _tmdb._query('$_endPoint/$tvId/episode_groups',
        method: HttpMethod.GET, parameters: parameters);
  }
  ...
  Future<Map> getExternalIds(int tvId) {
    assert(tvId != null);
    return _tmdb._query('$_endPoint/$tvId/external_ids',
  ...
  Future<Map> getKeywords(int tvId) {
    assert(tvId != null);
    return _tmdb._query('$_endPoint/$tvId/keywords', method: HttpMethod.GET);
  }

  /// Get a list of recommended tv show for a tv show.
  Future<Map> getRecommended(int tvId, {Parameters parameters}) async {
    assert(tvId != null);
    return _tmdb._query('$_endPoint/$tvId/recommendations',
  ...
  Future<Map> getReviews(int tvId, {Parameters parameters}) {
    assert(tvId != null);
    return _tmdb._query('$_endPoint/$tvId/reviews', parameters: parameters);
  }
  ...
  Future<Map> getScreenedTheatrically(int tvId) {
    assert(tvId != null);
    return _tmdb._query('$_endPoint/$tvId/screened_theatrically');
  }
  ...
  Future<Map> getSimilar(int tvId, {Parameters parameters}) {
    assert(tvId != null);
    return _tmdb._query('$_endPoint/$tvId/similar', parameters: parameters);
  }

  /// Get a list of translations that have been created for a tv show.
  Future<Map> getTranslations(int tvId) {
    assert(tvId != null);
    return _tmdb._query('$_endPoint/$tvId/translations');
  }
  ...
  Future<Map> getAiringToday({Parameters parameters}) {
    return _tmdb._query('$_endPoint/airing_today', parameters: parameters);
  }
  ...
  Future<Map> getOnTheAir({Parameters parameters}) {
    return _tmdb._query('$_endPoint/on_the_air');
  }
}
